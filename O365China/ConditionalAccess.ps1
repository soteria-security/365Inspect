...
function Inspect-CAPolicies {
    Try {
        ...
        If ($tenantLicense.ServicePlanName -match "AAD_PREMIUM*") {
            ...
            $secureDefault = ((Invoke-GraphRequest -method get -uri "https://microsoftgraph.chinacloudapi.cn/beta/policies/identitySecurityDefaultsEnforcementPolicy").Value)
            
            $conditionalAccess = (Invoke-GraphRequest -method get -uri "https://microsoftgraph.chinacloudapi.cn/v1.0/policies/conditionalAccessPolicies").Value
                ...
                Foreach ($policy in $conditionalAccess) {
                    ...
                    Elseif ($policy.conditions.users.includeusers) {
                        ...
                        Foreach ($user in $policy.conditions.users.includeusers) {
                            $IncludedUsers += (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/directoryObjects/$user").DisplayName
                        }
                    }
                    ...
                    Elseif ($policy.conditions.users.excludeusers) {
                        ...
                        Foreach ($user in $policy.conditions.users.excludeusers) {
                            $ExcludedUsers += (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/directoryObjects/$user").DisplayName
                        }
                    }
                    ...
                    Elseif ($policy.conditions.users.includegroups) {
                        ...
                        Foreach ($group in $policy.conditions.users.includegroups) {
                            $IncludedGroups += (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/directoryObjects/$group").DisplayName
                        }
                    }
                    ...
                    Elseif ($policy.conditions.users.excludegroups) {
                        ...
                        Foreach ($group in $policy.conditions.users.excludegroups) {
                            $ExcludedGroups += (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/directoryObjects/$group").DisplayName
                        }
                    }
                    ...
                    Elseif ($policy.conditions.users.includeroles) {
                        ...
                        Foreach ($role in $policy.conditions.users.includeroles) {
                            $IncludedRoles += (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/directoryObjects/$role").DisplayName
                        }
                    }
                    ...
                    Elseif ($policy.conditions.users.excluderoles) {
                        ...
                        Foreach ($role in $policy.conditions.users.excluderoles) {
                            $ExcludedRoles += (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/directoryObjects/$role").DisplayName
                        }
                    }
