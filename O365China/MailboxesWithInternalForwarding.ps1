...
Function Get-InternalMailboxForwarding {
    Try {
        ...
        $knownDomains = (Invoke-GraphRequest -method get -uri "https://microsoftgraph.chinacloudapi.cn/beta/organization?$select=verifiedDomains").Value.verifiedDomains.name
