...
Function Inspect-AppPasswords {
    Try {
        ...
        $apps = (Invoke-GraphRequest -Method Get -Uri "https://microsoftgraph.chinacloudapi.cn/beta/applications").value | Where-Object { $null -ne $_.passwordCredentials.KeyId }
