...
Function Inspect-EmailVerifiedUserCreation {
    Try {
        ...
        $emailVerifiedUsers = (Invoke-GraphRequest -method get -uri "https://microsoftgraph.chinacloudapi.cn/beta/users?filter=creationtype eq 'EmailVerified'" -ErrorAction Stop).Value
