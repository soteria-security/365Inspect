...
For example, to log in by entering your credentials in a browser with MFA support:
        ...
        .\365Inspect.ps1 -OrgName mytenant -OutPath ..\365_report -UserPrincipalName myuser@mytenant.onmicrosoft.com -Auth MFA
...
For example, CSV reports can be generated by calling the -ReportType parameter:
        ...
        .\365Inspect.ps1 -OrgName mytenant -OutPath ..\365_report -UserPrincipalName myuser@mytenant.onmicrosoft.com -Auth MFA -ReportType CSV

365*Inspect* can be run with only specified Inspector modules, or conversely, by excluding specified modules.

For example, to log in by entering your credentials in a browser with MFA support:

        .\365Inspect.ps1 -OrgName mytenant -OutPath ..\365_report -UserPrincipalName myuser@mytenant.onmicrosoft.com -Auth MFA -SelectedInspectors inspector1, inspector2

or

        .\365Inspect.ps1 -OrgName mytenant -OutPath ..\365_report -Auth MFA -ExcludedInspectors inspector1, inspector2, inspector3
