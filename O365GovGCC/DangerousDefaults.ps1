...
function Inspect-DangerousDefaults {
    Try {
        $permissions = (Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/beta/policies/AuthorizationPolicy").Value.defaultUserRolePermissions
        $authPolicy = (Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/beta/policies/AuthorizationPolicy").Value
        $caPolicy = (Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/v1.0/policies/conditionalAccessPolicies").Value | Where-Object { $_.Conditions.Applications.IncludeApplications -eq '797f4846-ba00-4fd7-ba43-dac1f8f63013' }
