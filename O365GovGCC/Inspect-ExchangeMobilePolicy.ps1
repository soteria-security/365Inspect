...
Function APPolicies {
    $Licenses = ((Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/beta/subscribedSkus").Value).ServicePlans
    ...
    If ((($licensed | Measure-Object).Count -gt 1) -and (($licensed -match "intune") -and ($licensed -ne "INTUNE_O365"))) {
        ...
        $iosPolicies = (Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/beta/deviceAppManagement/iosManagedAppProtections").Value
        
        $androidPolicies = (Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/beta/deviceAppManagement/androidManagedAppProtections").Value
...
Function CompPolicies {
    ...
    If ((($licensed | Measure-Object).Count -gt 1) -and (($licensed -match "intune") -and ($licensed -ne "INTUNE_O365"))) {
        $compliancePolicies = (Invoke-GraphRequest -method get -uri "https://graph.microsoft.us/beta/deviceManagement/deviceCompliancePolicies").Value
