...
Function Inspect-EmailVerifiedUserCreation {
    Try {
        ...
        $emailVerifiedUsers = (Invoke-GraphRequest -method get -uri "https://dod-graph.microsoft.us/beta/users?filter=creationtype eq 'EmailVerified'" -ErrorAction Stop).Value
